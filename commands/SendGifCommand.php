...
namespace Longman\TelegramBot\Commands\UserCommands {
    ...
    class SendGifCommand extends UserCommand {
        ...
        protected $name = 'sendgif';                      //your command's name
        protected $description = 'ارسال گیف';          //Your command description
        protected $usage = '/sendgif';                    // Usage of your command
            ...
            switch ($state) {
                ...
                case 8:
                    if (empty($text) || !($text == '✔️ تایید و ارسال')) {
                        ...
                        $data['document'] = $this->conversation->notes['document'];
                    ...
                    $databaser->addMessageToDatabase(
                        ...
                        $this->conversation->notes['document'],
