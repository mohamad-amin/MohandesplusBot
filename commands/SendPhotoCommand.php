...
namespace Longman\TelegramBot\Commands\UserCommands {
    ...
    class SendPhotoCommand extends UserCommand {

        protected $name = 'sendphoto';                      //your command's name
        protected $description = 'ارسال عکس';          //Your command description
        protected $usage = '/sendphoto';                    // Usage of your command
