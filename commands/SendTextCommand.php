...
namespace {
    ...
    class TextDatabaser {
        ...
        public function addMessageToDatabase($messageText, $channelName, $chatId, $time, $editTime)
        {
    ...
    class PersianDateFormatter {
        ...
        public static function format($notes) {
            return $notes['year'].'/'.$notes['month'].'/'.$notes['day'].' '.$notes['hour'].':'.$notes['minute'];
        }
